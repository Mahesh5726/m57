          ...
          <div className="border-t pt-6 sm:pt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
              ...
              <div className="group relative rounded-lg border p-4 sm:p-6 transition-all hover:border-foreground/20">
                ...
                <p className="text-sm sm:text-base text-foreground/60 mb-4">
                  A sleek, web application designed for a modern bakery
                  business. Supports dynamic theming (dark/light), animated UI
                  transitions, an interactive shopping cart, and a
                  component-driven architecture optimized for performance,
                  responsiveness, and seamless customer experience.
                </p>
